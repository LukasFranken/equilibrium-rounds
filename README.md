...
This Mod is VERY new and in active development.
Even though the cards should be relatively bug free,
...
>
#### Minigun
> Gain MANY bullets. While firing, attack speed increases gradually. NOTE: The attack speed is FIXED, meaning other cards do not affect the attack speed anymore - wether that is good or bad. Auto-reload is also disabled.
>
#### Evasion
> Blocking launches you back and heals (instantly) by a bit.
>
#### Cannonball
